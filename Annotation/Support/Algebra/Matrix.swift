...
extension Matrix {
    ...
    var diagonalize: (P: Matrix, D: Matrix, PInverse: Matrix)? {
        ...
        var index = -1
        while index + 1 < eigenvectors.count {
            index += 1
            let i = eigenvectors[index]
    ...
    var eigenvectors: [(eigenvalue: Fraction, eigenvector: Vector)]? {
        ...
        var index = -1
        while index + 1 < eigenvalues.count {
            index += 1
            let i = eigenvalues[index]
    ...
    var isIdentityMatrix: Bool {
        ...
        var i = -1
        while i + 1 < Int(self.size.height) {
            i += 1

            var ii = -1
            while ii + 1 < Int(self.size.width) {
                ii += 1
    ...
    var isElementaryMatrix: Bool {
        ...
        var i = -1
        while i + 1 < Int(matrix.size.height) {
            i += 1
            ...
            var ii = -1
            while ii + 1 < Int(matrix.size.height) {
                ii += 1
                ...
                var iii = -1
                while iii + 1 < Int(matrix.size.width) {
                    iii += 1
    ...
    var isSymmetricMatrix: Bool {
        ...
        var i = -1
        while i + 1 < (self.size.width-1) {
            i += 1

            var ii = (i+1) - 1
            while ii + 1 < self.size.width {
                ii += 1
